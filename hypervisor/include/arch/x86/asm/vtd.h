...
#define DMAR_INV_WAIT_IF		(1UL << 4U)
#define DMAR_INV_WAIT_SW		(1UL << 5U)
...
#define DMAR_INV_WAIT_DESC_LOWER	(DMAR_INV_WAIT_SW | DMAR_INV_WAIT_DESC | DMAR_INV_STATUS_DATA)

#define IOTLB_INV_LOWER_G_POS		4U
#define IOTLB_INV_LOWER_G_MASK		(0x3UL << IOTLB_INV_LOWER_G_POS)
#define IOTLB_INV_LOWER_DW_POS		6U
#define IOTLB_INV_LOWER_DW_MASK		(0x1UL << IOTLB_INV_LOWER_DW_POS)
#define IOTLB_INV_LOWER_DR_POS		7U
#define IOTLB_INV_LOWER_DR_MASK		(0x1UL << IOTLB_INV_LOWER_DR_POS)
...
#define IOTLB_INV_UPPER_AM_MASK		(0x3FUL << IOTLB_INV_UPPER_AM_POS)
