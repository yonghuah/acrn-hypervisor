...
{
	struct dmar_drhd_rt *drhd_rt = NULL;

	if (index < platform_dmar_info->drhd_count) {
		drhd_rt = &dmar_drhd_units[index];
	}
...
void dmar_invalid_context_cache_global(struct dmar_drhd_rt *dmar_unit)
{
 ...
 */
void dmar_invalid_iotlb_global(struct dmar_drhd_rt *dmar_unit)
{
